...
# Configuration
CSV_PATH = "data/labeled_sequences_uniprot_2026.csv" 
OUTPUT_DIR = "data/esm3_embeddings_2026"
...
with torch.no_grad():
    for _, row in tqdm(df.iterrows(), total=len(df)):
        ...
        try:
            ...
            # The LogitsConfig handles encoding and device placement natively!
            # Pass the raw `protein` object directly.
