    ...
    for true_idx, true_row in true_df.iterrows():
        ...
        for pred_idx, pred_row in pred_df.iterrows():
            ...
            if start_match and stop_match:
                # Use the true index on true_df and the pred index on pred_df. The
                # upstream code reused `idx` for both loops, marking a matched true at
                # the pred's index -> phantom rows dropped by groupby -> TP undercount.
